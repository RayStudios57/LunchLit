  ...
  if (isPast) {
    return (
      <Card className="card-elevated border-primary/30 bg-gradient-to-r from-primary/10 via-accent/5 to-primary/10">
        <CardContent className="py-6 flex flex-col items-center text-center gap-3 relative">
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="ghost" size="sm" className="absolute top-2 right-2 h-8 px-2 text-xs gap-1">
                <Settings className="w-3.5 h-3.5" />
                School's back
              </Button>
            </PopoverTrigger>
            <PopoverContent className="w-64 space-y-3" align="end">
              <p className="text-sm font-medium">Set your next last day of school</p>
              <Input
                type="date"
