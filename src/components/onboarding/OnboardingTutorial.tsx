...
import { Calendar, Heart, Dumbbell, Book, Trophy, Target, CheckSquare, Users, BookOpen, MessageCircle, GraduationCap, ArrowRight, ArrowLeft, Sparkles, Timer, Calculator, Award, Download } from 'lucide-react';
...
const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    icon: Calendar,
    title: 'Today View',
    description: 'Your daily dashboard shows upcoming classes, tasks due today, and quick-glance widgets — all in one place.',
    color: 'from-blue-500 to-cyan-500',
  },
  {
    icon: Heart,
    title: 'Wellness',
    description: 'Check in on your mood, track your water, get an easy snack of the day, and reset with a quick breathing exercise.',
    color: 'from-emerald-500 to-green-500',
  },
  {
    icon: Dumbbell,
    title: 'Fitness',
    description: 'Set your goals, build or AI-generate gym routines, scan machines to learn how to use them, log workouts for streaks, and share routines with friends.',
  ...
  },
  {
    icon: Target,
    title: 'College Prep',
    description: 'Plan for college with goals, target schools, a college predictor, and a live scholarship finder.',
