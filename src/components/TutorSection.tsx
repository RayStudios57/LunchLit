      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Get help from your fellow students</p>
          </div>
        </div>
      </div>

      <div className="grid gap-4 sm:grid-cols-2">
        {tutors.map((tutor, index) => <div key={tutor.id} className="card-interactive p-4 opacity-0 animate-fade-up" style={{
        animationDelay: `${index * 0.1}s`
            ...
            <Button variant="ghost" size="sm" className="w-full mt-3 justify-between text-muted-foreground hover:text-foreground">
