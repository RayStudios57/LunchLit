...
export function useAdminUserRoles() {
  ...
  const { data: users = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      roles?.forEach((role: { id: string; role: AppRole; school_id: string | null; custom_role_id?: string | null; custom_roles?: { display_name?: string; color?: string } | null; user_id: string }) => {
