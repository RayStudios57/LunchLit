...
const changelogData = [{
  ...
  changes: [
    ...
    'Expanded to 32 achievement badges across 7 categories (Tasks, Brag Sheet, Academic, Consistency, Exploration, Participation, Milestones)',
    'Special "LunchLit Master" badge for completing all achievements',
    'Redesigned Badges page with category sections, progress tracking, and hover details',
    'Weekly Inspirational Quotes (52+ quotes, rotates each week)',
    'Removed Quick Links for a cleaner dashboard layout',
...
const features = [
  ...
  { icon: Award, label: '32 Badges', desc: 'Unlock achievements across 7 categories' },
